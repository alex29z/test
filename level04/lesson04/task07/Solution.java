...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        if (krat(year, 100))
        {
           if (krat(year, 400)) System.out.println("количество дней в году: 366");
            else System.out.println("количество дней в году: 365");
        }
        else
        {
            if (krat(year, 4)) System.out.println("количество дней в году: 366");
            else System.out.println("количество дней в году: 365");
        }

    }
    public static boolean krat(int a, int b)
    {
      //  if (a/b*b == a)
            return (a/b*b == a);
       // else return false;
